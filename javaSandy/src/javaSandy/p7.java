...
public class p7 {
	...
	// <<<");
	// System.out.println("Enter a simplified arithmetic post-fix expression with no
	// white-spaces:");
	...
	// System.out.println("\n");
	//
	// // 4. Clone the tree and swap the ' + ' and ' * ' operators in the cloned
	// tree
	...
	// System.out.println("The value of the new tree: " +
	// BSTree.evaluateCloned(treeCopy.getRoot()));
	// System.out.println("\n");
	//
	// // 7. Re-evaluate the orginal tree.
	// System.out.println("The value of the original tree: " +
	// BSTree.evaluate(tree.getRoot()));
	//
	// System.out.println("\n\n");
	// }
	// }
