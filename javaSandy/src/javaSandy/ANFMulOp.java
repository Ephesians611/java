...
/**
 * A representation of the multiplication operation for ANF-expressions.
 *
...
public class ANFMulOp extends ANFBinOp {
	 ...
	 *
	 * @param x1
	 *            the ANFVarExp that is the first operand of the multiplication
	 *            operation
	 * @param x2
	 *            the ANFVarExp that is the second operand of the multiplication
	 *            operation
	 */
