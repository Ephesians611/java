...
public class Parser {
	...
	/**
	 * Build a data structure representation of the lerp expression written as a
	 * string.
	 * 
	 * @param s
	 *            a String that contains the text of a lerp expression
	...
	/**
	 * Creates a new Expression if the position at tokens is an open/closed
	 * parenthesis position is then updated
	 *
	...
	/**
	 * Reads through the position of tokens and executes helper methods when a
	 * number/mathematical symbol is found
	 *
