package javaSandy;
/* Generated By:JJTree&JavaCC: Do not edit this line. P2TokenManager.java */

/** Token Manager. */
public class P2TokenManager implements P2Constants {
	...
	public static final String[] jjstrLiteralImages = { "", null, null, null, null, null, null, null, null, null, null,
			null, null, null, "\53", "\55", "\52", "\57", "\45", "\50", "\51", };

	/** Lexer state names. */
	public static final String[] lexStateNames = { "DEFAULT", };
	static final long[] jjtoToken = { 0x1fc881L, };
	...
	/** Constructor. */
	public P2TokenManager(SimpleCharStream stream) {
	...
	/** Constructor. */
	public P2TokenManager(SimpleCharStream stream, int lexState) {
		this(stream);
		SwitchTo(lexState);
	}
