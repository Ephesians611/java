...
/**
 * An abstract class to characterize the common data associated with ANF binary
 * operators.
 *
...
public abstract class ANFBinOp implements ANFOp {
	 ...
	 *
	 * @param x1
	 *            the ANFVarExp that is the first operand of the binary operation
	 * @param x2
	 *            the ANFVarExp that is the second operand of the binary operation
	 */
