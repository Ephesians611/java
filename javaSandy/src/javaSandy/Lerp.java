...
/**
 * A class that contains the static methods that provides an entry point and
 * textual user interface for the lerp compiler.
 * 
...
public class Lerp {
	...
	/**
	 * Load the file associated with the specified file name into memory as a
	 * string.
	 *
	 * @param filename
	...
	/**
	 * No command line arguments entail interactive mode. A single command line
	 * argument is treated as a file name and entails non-interactive mode: the file
	 * is read in compiled and the generated code is displayed.
	 *
	 * @param args
