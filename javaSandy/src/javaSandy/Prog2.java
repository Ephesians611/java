...
class Prog2/*@bgen(jjtree)*/implements Prog2TreeConstants, Prog2Constants {/*@bgen(jjtree)*/
  protected static JJTProg2State jjtree = new JJTProg2State();public static void main(String args[]) {
    ...
    try {
      ...
      Prog2 sVarToSubstitute = new Prog2(System.in);
      
      System.out.println("Enter the substituting applied Lambda expression:");
      Prog2 exprToSubstituteVarIn = new Prog2(System.in);
      ASTStart n2 = sVarToSubstitute.Start();
      SimpleNode expr2 = (SimpleNode)n2.jjtGetChild(0);
   ...
   // Print the abstract syntax tree substitution result 
      ...
      ASTStart n3 = t2.Start();
      SimpleNode expr3 = (SimpleNode)n3.jjtGetChild(0);
      System.out.println("The applicative order evaluation result:");
      expr3.applicativeOrderEvaluate();
